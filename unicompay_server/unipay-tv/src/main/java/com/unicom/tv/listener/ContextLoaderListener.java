...
package com.unicom.tv.listener;
...
public class ContextLoaderListener extends org.springframework.web.context.ContextLoaderListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		try {
			loadCacheConfiguration("/runtime.properties");
		} catch (IOException e) {
			throw new RuntimeException("can not load runtime.properties! ");
		}
	}

	private void loadCacheConfiguration(String fileLocation) throws IOException {
		RuntimeProperties.initProperties(fileLocation);
	}
